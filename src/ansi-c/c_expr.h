...
{
public:
  explicit history_exprt(exprt variable) : unary_exprt(ID_old, std::move(variable))
  {
  }
...
inline const history_exprt &to_history_expr(const exprt &expr, const irep_idt &id)
{
